...
try {
    ...
    $stmt = $pdo->prepare("SELECT 
                            ...
                            CASE 
                                ...
                                WHEN completedStep = 8 THEN 'Step 9 - Completed'
                                WHEN completedStep = 9 THEN 'Step 9 - Completed'
    ...
    // Step 9: completedStep = 8 (Completed after Step 8)
    if ($residence['completedStep'] == 8) {
        $appearsIn[] = 'Step 9 (Completed)';
    }
    
    // Completed: completedStep = 9
