...
try {
    ...
    if ($step == 1) {
        ...
        if ($chargedOpt == 1 || $chargedOpt == 3) { // 1 = Account, 3 = Credit Card
    ...
    // Step 4: E-Visa
    elseif ($step == 4) {
        $eVisaCost = isset($_POST['eVisaCost']) ? (float)$_POST['eVisaCost'] : (isset($_POST['evisa_cost']) ? (float)$_POST['evisa_cost'] : null);
        $eVisaCur = isset($_POST['eVisaCur']) ? (int)$_POST['eVisaCur'] : (isset($_POST['eVisaCostCur']) ? (int)$_POST['eVisaCostCur'] : null);
        
        // Handle charged entity
        $eVisaSupplier = null;
        $eVisaAccount = null;
        $chargedOpt = isset($_POST['eVisaChargOpt']) ? (int)$_POST['eVisaChargOpt'] : (isset($_POST['eVisaTChargOpt']) ? (int)$_POST['eVisaTChargOpt'] : null);
        $chargedEntity = isset($_POST['eVisaChargedEntity']) ? (int)$_POST['eVisaChargedEntity'] : (isset($_POST['eVisaTChargedEntity']) ? (int)$_POST['eVisaTChargedEntity'] : null);
    ...
    elseif ($step == 5) {
        ...
        $chargedOpt = isset($_POST['changeStatusChargOpt']) ? (int)$_POST['changeStatusChargOpt'] : (isset($_POST['changeSChargOpt']) ? (int)$_POST['changeSChargOpt'] : null);
        $chargedEntity = isset($_POST['changeStatusChargedEntity']) ? (int)$_POST['changeStatusChargedEntity'] : (isset($_POST['changeSChargedEntity']) ? (int)$_POST['changeSChargedEntity'] : null);
    ...
    elseif ($step == 7) {
        ...
        $emiratesIDCur = isset($_POST['emiratesIDCur']) ? (int)$_POST['emiratesIDCur'] : (isset($_POST['emiratesIDCostCur']) ? (int)$_POST['emiratesIDCostCur'] : null);
        $EmiratesIDNumber = isset($_POST['emiratesIDNumber']) ? trim($_POST['emiratesIDNumber']) : (isset($_POST['EmiratesIDNumber']) ? trim($_POST['EmiratesIDNumber']) : null);
        
        // Handle charged entity
        $emiratesIDSupplier = null;
        $emiratesIDAccount = null;
        $chargedOpt = isset($_POST['emiratesIDChargOpt']) ? (int)$_POST['emiratesIDChargOpt'] : (isset($_POST['emirateIDChargOpt']) ? (int)$_POST['emirateIDChargOpt'] : null);
    ...
    // Step 9: Completed (EID Delivered) - Step 9 (EID Received) has been removed
    elseif ($step == 9) {
        ...
        // Handle EID images (for backward compatibility if needed)
        $eid_front_image = '';
        $eid_back_image = '';
        ...
        // File upload removed - Step 9 is now just completion marker
    }
    
    else {
        $pdo->rollBack();
        JWTHelper::sendResponse(400, false, 'Invalid step number. Must be between 1 and 9 (Step 9 EID Received has been removed)');
    }
