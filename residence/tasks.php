 ...
 * Returns filtered residence list based on step, company, customer, and search
 */
...
try {
    ...
    if ($customer_id > 0) {
        $where .= " AND residence.customer_id = :customer_id ";
    ...
    if ($customer_id > 0) {
        ...
        $countParams[':customer_id'] = $customer_id;
    }
    if ($search != '') {
    ...
    if ($customer_id > 0) {
        $sql1a .= " AND customer_id = :customer_id ";
        $params1a[':customer_id'] = $customer_id;
    }
    if ($search != '') {
    ...
    if ($customer_id > 0) {
        $sql2 .= " AND customer_id = :customer_id ";
        $params2[':customer_id'] = $customer_id;
    }
    if ($search != '') {
    ...
    if ($customer_id > 0) {
        $sql4a .= " AND customer_id = :customer_id ";
        $params4a[':customer_id'] = $customer_id;
    }
    if ($search != '') {
    ...
    if ($customer_id > 0) {
        $sql5 .= " AND customer_id = :customer_id ";
        $params5[':customer_id'] = $customer_id;
    }
    if ($search != '') {
